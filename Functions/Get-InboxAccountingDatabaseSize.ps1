...
.SYNOPSIS
    Report the size of the Remote Access inbox accounting database.
...
.LINK
    https://github.com/richardhicks/InboxAccountingDatabaseManagement/blob/main/Functions/Get-InboxAccountingDatabaseSize.ps1
...
Function Get-InboxAccountingDatabaseSize {
    ...
    Try {
        ...
        $Size = $Files | ForEach-Object { Get-Item $_.current_file_location } | Select-Object Name, @{Name="MB"; Expression={[Math]::Round($_.length/1MB, 2)}}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUTxc66brQ5uI3gTPCmN1FgY/u
# g6uggiDDMIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# MRYEFK1oUQ2m6OaqMXUJSCbajxliaVhGMA0GCSqGSIb3DQEBAQUABIIBgGrBaMrq
# aOfXNHPe495hcDGM8MPRIxIhna3HIHmVn4J4oPZmmwUaY6gkTAbjoPII+EO1iwor
# IJ+zsyTL3NUMbeCya+jLu9Sv9QPzyYgdwB7RLgKp3uo8XLfybPfw6r4bf6XYQYQ4
# 1qTedYBu66ntOlwFZ/UvnBEmUOzItvv8YVNN6oRTuOwcN2wfz3SWUmyDUpictodQ
# 7RGBt2aRd+s9dt/JXR4vcbimtfXRPcoHp5aOjzZJzhmHD6YdXBAJ5dcqmn6jyeNi
# u7TxjuHLPnC0YkL52qRAo4EUGlBBjAolibXshhXqc9X7Xuk9+GHrwamPDUsmwEIa
# A6SYnJS+OWzBmPurlysenHV++ImbFGSFOdajNmpBG9L2Uph4b4P6Cg/tK55x738+
# M+8x4QEup51K+uPkfDuM3UyvWbma//j5ns4FJkFnzJzd5RGtnYWGoD6BRW9GKbJy
# hptczOhaa5a97DICLQtNJJWaqsCjHSCI/ogjaYDcSzQSfWEiYu5sKyFMlqGCAyAw
...
# CSqGSIb3DQEJBTEPFw0yMzEyMTEyMjU2MjZaMC8GCSqGSIb3DQEJBDEiBCBzanF1
# U9F2HvxDTFCp7fhJYo9rgVyvlxUrRwiI5DEzojANBgkqhkiG9w0BAQEFAASCAgAY
# 7JLcmF2KXsluxJtS7gUhkYhrq2TGuJRmvV1ijl5KUoUHkb8I/1IzmT/0YyMmEMAS
# T2yBfVR5GoRdnbiostnufeSrcrJ4gmKHW7Cbvjzkt5t1B+82F/IokPnWgND/IcO7
# 97yVhMCDNQmAmpBhFVaTSO1sVvD7DDCSN+Bz4VfFzjwEH2g4WCSZX6VmS3T6TebM
# BuNtCEW/u/8IL0rGZepNdPocMUAl+l0+7RgeVLY5MGmxKg78hoIfkIoVPO232KSU
# oWHaSPb+6sKRCrtnqs+WorfoW+KPlQU1j1hfmU/l7hmyt82awcxFndtTbnolOKcv
# ekBwc4NN7MCFNFN8WG0Wekd7xMypW0lEzeGAGHeJn2XBAFLj233dVtLDq211UvYq
# GSlbV0kN2Ut/fOStUqYyCjgF9R1h1MM9dXm/sxotUKCP5CigcdewULbtGgywDjWn
# MJeG3ujzr2qyJUX99aPHTT9zsxkg89lEOC+75guUai2ZTvwzhEKEvp53tQcpDlff
# 3uhLGEiEOsvVJCODxmQjLZICGwZ3oAaOBvFBJfeNq+Z16mEa8n8yzK1hv31q9RTy
# bZ9FmNx0Cwz2DJAXhHY1vvt0mpD9qoJLZYfkC04EDtFS2oL3nSqoYU7DPt+wKws6
# 2FYfOgbdpOutD2YgYNcDL/d11kM8mUFhR3ZWUjhCfQ==
