...
.SYNOPSIS
    Perform a disk backup of the DirectAccess/Routing and Remote Access Service (RRAS) inbox accounting database.

.PARAMETER BackupFile
    The location to store the inbox accounting database backup. The default location is C:\Windows\DirectAccess\db\RaAcctDb.bak.

.EXAMPLE
    Backup-InboxAccountingDatabase

    Run this command to back up the inbox accounting database in the default location of C:\Windows\DirectAccess\db\.

.EXAMPLE
    Backup-InboxAccountingDatabase -BackupPath 'C:\Backups\RaAcctDb.bak'

    Run this command to back up the inbox accounting database to the C:\Backups\ folder.

.DESCRIPTION
    This PowerShell script is used to perform a disk backup of the Remote Access inbox accounting database. The backup can be used to archive data prior to purging the inbox accounting database. It can also be used to migrate accounting data when upgrading the server.

.LINK
    https://github.com/richardhicks/InboxAccountingDatabaseManagement/blob/main/Functions/Backup-InboxAccountingDatabase.ps1
...
Function Backup-InboxAccountingDatabase {

    [CmdletBinding()]

    Param (

        [string]$BackupFile = "C:\Windows\DirectAccess\db\RaAcctDb.bak"
    ...
    Try {
        ...
        $Command.CommandText = "BACKUP database RaAcctDb TO DISK='$BackupFile' WITH DESCRIPTION = 'Full backup of the RemoteAccess accounting database taken on $((Get-Date).ToShortDateString()) at $((Get-Date).ToShortTimeString()).', INIT"
        $Connection.Open()
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUuqSRBXtRV//RWKuQf3JCT2lN
# jL2ggiDDMIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# MRYEFGPtJY9aOOf41QS3vzEL73KpGi+FMA0GCSqGSIb3DQEBAQUABIIBgL0Cd9PS
# 5pS10PsXJ/26wduhOP5Ko+TUp6QzCIiTu45BqArg9wVgYanXrpoPV6vGJKwwhrot
# uCbzt3RosNMHCaZMS5/uI0NRkyc3N0YP++xwQ1HtlGA78BTi3w94YaXMYXK1XPDd
# sS7fPniVYn9dOzwkiOz3u/jcfqA4x+iAlDkWOvd5CcsmuHk85zhnstJQ1Q2vxvD5
# 7YoAIErRJAvg3bVXK0HG0zaYUhCmn59+CjXJdAZbc0EgsdpxC5PMegBLNalq+E8Z
# Mj0jpAynuNEQOWjbifIrdS0N4212/mSMbHTxCxD6zc5J9wGe/e9+3RQczf9IpGQJ
# hHBB2m3Tbx1DpI9+xz8S0zfkkQcKdJrQLTsTyB9aH0UejaI0zR+axjujtnQv5+1X
# QYTprI7oG2WJ4bQRhzv7f4EoekFKq7atJXndzStxboIBH+3q1FFkoUx/ch/e4SDq
# 50A3pnaP6JMUAFZjjjq1rOX/bSWdpNoaDsPbr5pHNp1ZkfgdSsKYkbMxOqGCAyAw
...
# CSqGSIb3DQEJBTEPFw0yMzEyMTEyMjU2MjVaMC8GCSqGSIb3DQEJBDEiBCDLMkmL
# pDCgF18p4La99c0DlxNktRl5GSBRrpMq72ftEDANBgkqhkiG9w0BAQEFAASCAgAA
# pT5Q59aRgiYZSxyNyH9nJ5xjmMK/JovAdNoFfWFB5MnxGhxeUQrtbhxdJ5d+rgcq
# sDvaL7TNCuLQqL1wY9Oh+uVDH2dCvzzCWHUeyejl7G7CenvK0/QLaJ4aBcrCpnEW
# srV/UlO4/3UzT5XtPtkYNkFyP6NItkJShAEAsB0tQEJz5NjZiS2VPLhMMxBcAaEm
# JUv7EU+hPdg/vSpqgGdufnaNu08/9z4Y2liJH9XTk/t5ei9ifiNXep4Kk5vP87PG
# 7JwqTbOmYuF8RhdE6TwHxz6SqRBXBQuM58mcYJkHwE6c9+XavSQpMdimjYjVmDwr
# BOoA+CH9fnrvreDPE5/+YDTH65wfEKvS5GhAZ7ewp+ALml5CJQivQkEtUxkpoAZr
# GTkhSIGbVutfWTYYoVLJ7o8m0b+yWfs1BGB/AVUd3XJ1YZvbVAf7FOYqI/QRUjZE
# NoHQTg6xXcDiBQpkH9HkA3FjijC/xsCuWKU85Oweu0bLpTpyxEDyxVzlvRM3/LKK
# B02433DxaK1YvX7lGV224h9YQrFcvk3Zwvl9VaYIIWAzN3uWTDzLAtNfCkGQjPTk
# YvbXz9TLabAtqjJVvaFzp/v6RUb8pLGHTY2TWn4jB5Y4hOjRipiEMRyDWTPSPOzy
# JTv6rjRyZmoWQD71itPcB5L+upp5oA8Cw21A7x17iA==
