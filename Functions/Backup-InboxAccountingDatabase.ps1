...
.EXAMPLE
    Backup-InboxAccountingDatabase -BackupPath 'C:\Backups\'

    Run this command to back up the inbox accounting database to the C:\Backups\ folder.

.EXAMPLE
    Backup-InboxAccountingDatabase -Overwrite
...
Function Backup-InboxAccountingDatabase {
    ...
    # // Check for existing backup file and overwrite if specified
    ...
    If (Test-Path $BackupFile) {
        ...
        Else {
            ...
            Write-Warning "Backup file already exists. Use the -Overwrite switch to overwrite the file."
            Return
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU2kURQeMvpaVAM6I4wapzct0f
# R0qgghs2MIIGrjCCBJagAwIBAgIQBzY3tyRUfNhHrP0oZipeWzANBgkqhkiG9w0B
...
# AYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSqmofpvrx7jryGihzjUM/IIsgAmjANBgkq
# hkiG9w0BAQEFAASCAYCG3wH6av26YzC4vi630GClLPIA7NmAzzEC0wdrDDpX3RHJ
# bqYWpKyBqPIIr4aUFHxkHIysetIxrb+hoy8bIcCh6AIRJK4OnkAT/cN6cDGxVILi
# 6VomPXUiVVgamjIAAilswFawM/qB1o+pIwkRfONd0llvyy3CZ1BviHdFet+K21vh
# eDzK34DZqs/qbOsLivg9iLS6pY48zbFE5MwEaSpVEip3I58dT59WsXQq8P2V4tuQ
# vypTNPraS8thFXe3xH5/Ai0DpAu03zxbgevPDcPXgPfWCft87iseNvMmQw18p78+
# 8+xNOAGgltoBFWq+YPN0b2eFcfj2KCdxbS5caiSIMQwEKFkFs7Op5Q6+lK7XgPDW
# Rin2yYkptWBbPrw9KdZEqt0js/P/G3Ja4a+VTUj1QqXT1PRkPuq9ey591muyXnHk
# vXfD365ux0DSgm9x//avP7NdXYyxiBrucyOGWJauDh/jxVIy9/aYNch6wwYVYg9Y
# HKC3BG0hKWevP055nVihggMgMIIDHAYJKoZIhvcNAQkGMYIDDTCCAwkCAQEwdzBj
...
# BgkqhkiG9w0BCQQxIgQgtVdeyFoBRmUra34BvzYzgYpMvmAzdlvPJc85jasq8mYw
# DQYJKoZIhvcNAQEBBQAEggIArqh0U/IbS9KDtiFrUKG0m+/Gg9mORpztCmoH+AAd
# yFslQu8d97bvUzYN7tI6pyY8ROKCCjyky9sScE4iv3CVegIIhFwQ9QQKLwWT1vaZ
# Nc2sem3W74nqCH6duOmX+68nulYjsfM3YbJfqmK5k23H/pokx1LekPzTBjAdYtaw
# J2hojOSiLQWS5ps7N/0AneUvTVUCtvqnC58HjYDb6KqtBA4i0GxQjTcalfv2eAiw
# S7JS2kXNl/uymeIlvfhOKWvtfhWT1vfLkHpmNeAWO1Pw7CQkFfEQ6XFpnydsiBKd
# LSr1Hxcaq2v7XJOQkXRf+ZtkQndfQw2upMo71Ldl3LMsPYFU3SJLEOmCsO3bZ6rC
# FilvS2lER9J4UkOZe6SeyLE6JSgvF3y/zL4zXeezu9fyQQruMjvRZviJugbFbVXw
# 77fJ2csZhlKJmYO0NCx+9TZtpR0/TYtLJpLdPef7rJfCEFU6a9EisreSKtwSdzp2
# f6ObMemWo7URdC3Mda3Y8aMyCHSRX3v5Gcj4mKei8IPZmjzQz2jQVsay4XDysZJH
# 1/FxW1PzAHR5Gacx1mfk+YmtvMZQNz+GOUb7F0Opp5umIkQR5mRBCfthGNzBkYKJ
# q24NoTyOQRZFqFq3Rn2jgDWylGL689iQE+drDx024zvXFgQNiimnSeM6jGJVObdS
# pac=
