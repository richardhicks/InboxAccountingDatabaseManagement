...
.SYNOPSIS
    Performs a database restore from a previous disk backup of the DirectAccess/Routing and Remote Access Service (RRAS) inbox accounting database.

.PARAMETER BackupFile
    The location of the inbox accounting database backup file. The default location is C:\Windows\DirectAccess\db\RaAcctDb.bak.

.EXAMPLE
    Restore-InboxAccountingDatabase

    Run this command to restore the inbox accounting database with a backup file from the default file location of C:\Windows\DirectAccess\db\RaAcctDb.bak.

.EXAMPLE
    Restore-InboxAccountingDatabase -BackupFile 'C:\Backup\RaAcctDb.bak'

    Run this command to restore the inbox accounting database with a backup file from the custom file location of C:\Backup\RaAcctDb.bak.

.DESCRIPTION
    This PowerShell script is used to perform a database restore from a previous disk backup of the Remote Access inbox accounting database.

.LINK
    https://github.com/richardhicks/InboxAccountingDatabaseManagement/blob/main/Functions/Restore-InboxAccountingDatabase.ps1
...
Function Restore-InboxAccountingDatabase {

    [CmdletBinding()]

    Param (

        [Parameter(Mandatory, HelpMessage = 'Enter the full path to the database backup file.')]
        [string]$BackupFile
    ...
    # // Check for existing backup file. Exit if it doesn't exist
    Write-Verbose "Checking for backup file $BackupFile..."
    If (!(Test-Path $BackupFile)) {

        Write-Warning 'Backup file does not exist.'
        Return

    }

    # // Restore inbox accounting database
    Write-Verbose "Restoring inbox accounting database from backup file $BackupFile..."
    ...
    Try {
        ...
        $Command.CommandText = "ALTER DATABASE RaAcctDb SET SINGLE_USER WITH ROLLBACK IMMEDIATE;RESTORE DATABASE RaAcctDb FROM DISK ='$BackupFile' WITH REPLACE;ALTER DATABASE RaAcctDb SET MULTI_USER"
        $Connection.Open()
        $Command.ExecuteNonQuery() | Out-Null
        $Connection.Close()
        Write-Verbose "Inbox accounting database restored from backup file $BackupFile."
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUpohjAKi/mXuWoFZ5EEATuI+n
# j96ggiDrMIIFsTCCBJmgAwIBAgIQASQK+x44C4oW8UtxnfTTwDANBgkqhkiG9w0B
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRdDa1M
# 4Wh3kq2qPWT3c06b6bsv1jANBgkqhkiG9w0BAQEFAASCAYBUHkC7HXYdgyLaz043
# aMb0WBtam/YKKAyNMdHG46o/RVWvo4HtpIAGvJBafe/tzaHxLEoISQHOUw+v1E2T
# JlPgdErN+uLjrLIa93RDMlxonWESC4e0aF5pJby1HuavXkUwIECgCPCj1mC5Q/el
# 2wJPiZi2qaPgWnNa56uUnLYLhkYKGUhUyHSCMQze6XqJOsCZGQtPrw9hyTzo+VVe
# jDpu757A+nOWTRsgaJsz8J5BoDYPC5jmHjU3o0SkNybSer9AOIUXH18jvNaIz2r0
# Hdxu7UZLh77c1+c2PAzzI0gS155CB0K+y1tfj5uYIkNjdhxMdmfMthwx4EPnpK+C
# lIqHtpOM147tbtby3Wr1dspfOonZvVDhwoUPoQS/KP94Mg5RiYgfbwe/vo+GQq9I
# YF4aoHhtYgubnlh1o9Q3ZxvKCEyeGvG4Id9TmR6Wt8ZHcqAi2JG16VNw3L0IBlOn
# k7t99iLRedH+tIjtdR94oOSpHz+EI8UVQlTRmR5xvlBa9puhggMgMIIDHAYJKoZI
...
# CQUxDxcNMjIwNzE1MTcxMzIxWjAvBgkqhkiG9w0BCQQxIgQgbNHP/w2tkVP5FK0M
# NokUO6vHgQtgW0yxfpVhuTexMR4wDQYJKoZIhvcNAQEBBQAEggIApamZS9EITxtc
# ey/Vkgl7n4qbiyFqCcaPuvNhVunX0alq1d0Bck1pkVQa6t4LKbSh05IN0DArs9nT
# fHULTNfW77jW/Ui6QaHsNgAi7OHwshtbTcE6t4GPPaddxWqsDmDjOPrQo7a4TV8G
# oGHz2ZHBI0JEN0lE9dbnaro7h15iLaFow1eyNMGGgaPmmOOPNjPHLIeENJMOAmeF
# xUQ6B5JCfQvjzAWZbpaOFPVp6CBNSCer531oZOrO5v8g2ONckpTpLDTe+RyfAW6I
# RxNURUIz859Rm8OCxuqUDQKV8p68W5BslklEDwUDQInMFvI4EylNqVd9LWczS6/C
# tGCdWBvXKn+eil1VUT6N3x082idA7rX9PXAl9BsMxuu4ZigZ/XHZAutG1O5KroVU
# lGFysc20Nql2lV0o58EhBbHeexhKxjQkXEECEMrmpU4l/H0weq0O5MDjn7PYNLek
# Wssai7D9Yv0LVx0WzWI8x2Txx/2HmdWDY904GEdEI0JP8mbpdDPjmoilgHn14wkD
# TNgJMDlaNEFfaZ5Emmcga4VUxHDPxrPEanxb3JyN5I33jOPsGyfOVsEZRv3QYLra
# iX45ahQClrpt9JF9wkBxFHOlZL9u7GYkqSEvsfmfjCeh1BlFkhyRaqWIc1Xi3YdA
# c1BCOWSWvqHn0oXItk7uST8eVtHskB4=
